...
var csv2 = "Drug Name, Num Values Entered, Target Type, Key Press, Current Number, Time, First Seen Number, Dose Entered<br/>";
...
$("document").ready(function() {
	...
	$(document).keydown(function(e) {
		...
		if (!stopped) {
			...
			csv2 = csv2 + drugName + ',' + numValuesEntered + ',' + currDiv + ',' + key + ',' + amount + ',' + (e.timeStamp - timeOffset) / 1000 + ',' + firstSeen + ',' + dose + '<br/>';
			...
			if (calcTime > 180000) {
				...
				new_window.document.write(csv2);
